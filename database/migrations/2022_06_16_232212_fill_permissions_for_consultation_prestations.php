...
class FillPermissionsForConsultationPrestations extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForConsultationPrestations constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Consultation Prestations Module' => 'consultation-prestations',
            'List All Consultation Prestations' => 'consultation-prestations.index',
            'Create New Consultation Prestations' => 'consultation-prestations.create',
            'View Any Consultation Prestation' => 'consultation-prestations.show',
            'Edit or Update a Single Consultation Prestation' => 'consultation-prestations.edit',
            'Delete Consultation Prestations' => 'consultation-prestations.delete',
        ]);
