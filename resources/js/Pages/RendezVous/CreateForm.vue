<template>
    <form class="w-full" @submit.prevent="storeModel">
        ...
        <div class=" sm:col-span-4">
            ...
            <infinite-select :per-page="15" :api-url="route('api.salle-d-attentes.index')"
        ...
        <div class=" sm:col-span-4">
            ...
            <infinite-select :per-page="15" :api-url="route('api.rendez-vous-statuses.index')"
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            async storeModel() {
                this.form.post(this.route('admin.rendez-vouses.store'),{
                    onSuccess: res => {
