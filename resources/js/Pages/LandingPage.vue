                ...
                <div class="container relative flex flex-wrap items-center justify-between h-24 mx-auto overflow-hidden font-medium border-b border-gray-200 md:overflow-visible lg:justify-center sm:px-4 md:px-2">
                    ...
                    <div class="top-0 left-0 items-start w-full h-full p-4 text-sm bg-gray-900 bg-opacity-50 md:items-center md:w-3/4 md:absolute lg:text-base md:bg-transparent md:p-0 md:relative md:flex" :class="{'flex fixed': showMenu, 'hidden': !showMenu }">
                        <div class="flex-col w-full h-auto overflow-hidden bg-white rounded-lg md:bg-transparent md:overflow-visible md:rounded-none md:relative md:flex md:flex-row">
                            <a href="#_" class="inline-flex items-center block w-auto h-16 px-6 text-xl font-black leading-none text-gray-900 md:hidden">tails<span class="text-green-600">.</span></a>
                            <div class="flex flex-col items-start justify-center w-full space-x-6 text-center lg:space-x-8 md:w-2/3 md:mt-0 md:flex-row md:items-center">
                                <inertia-link :href="$page.props.app.url" class="inline-block w-full py-2 mx-0 ml-6 font-medium text-left text-green-600 md:ml-0 md:w-auto md:px-0 md:mx-2 lg:mx-3 md:text-center">Home</inertia-link>
                                <a href="#features" class="inline-block w-full py-2 mx-0 font-medium text-left text-gray-700 md:w-auto md:px-0 md:mx-2 hover:text-green-600 lg:mx-3 md:text-center">Features</a>
                                <a href="#docs" class="inline-block w-full py-2 mx-0 font-medium text-left text-gray-700 md:w-auto md:px-0 md:mx-2 hover:text-green-600 lg:mx-3 md:text-center">Blog</a>
                            </div>
                            <div class="flex flex-col items-start justify-end w-full pt-4 md:items-center md:w-1/3 md:flex-row md:py-0">
                                ...
                                <inertia-link v-if="!$page.props.user && canRegister" :href="route('register')" class="inline-flex items-center w-full px-6 py-3 text-sm font-medium leading-4 text-white bg-green-600 md:px-3 md:w-auto md:rounded-full lg:px-5 hover:bg-green-500 focus:outline-none md:focus:ring-2 focus:ring-0 focus:ring-offset-2 focus:ring-green-600">Sign Up</inertia-link>
                                <inertia-link v-if="$page.props.user" :href="route('profile.show')" class="inline-flex items-center w-full px-6 py-3 text-sm font-medium leading-4 text-white bg-green-600 md:px-3 md:w-auto md:rounded-full lg:px-5 hover:bg-green-500 focus:outline-none md:focus:ring-2 focus:ring-0 focus:ring-offset-2 focus:ring-green-600"><i class="fas fa-user-circle text-primary-400 mr-2"></i> {{$page.props.user.email}}</inertia-link>
                            </div>
                        </div>
                    </div>
