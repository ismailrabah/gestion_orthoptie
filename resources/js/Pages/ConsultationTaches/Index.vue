<template>
    <jig-layout>
        <template #header>
            <div class="flex flex-wrap items-center justify-between w-full px-4">
                ...
                <div class="flex gap-x-2">
                    <inertia-button v-if="can.create" :href="route('admin.consultation-taches.create')" classes="bg-green-100 hover:bg-green-200 text-primary"><i class="fas fa-plus"></i> New
                        Consultation Tach</inertia-button>
            ...
            <div class="z-10 flex-auto bg-white md:rounded-md md:shadow-md">
                ...
                <div v-if="showModal && currentModel">
                    <jig-modal
                        ...
                        <template #title>Show Consultation Tach #{{currentModel.id}}</template>
                        <show-consultation-taches-form :model="currentModel"></show-consultation-taches-form>
                        <template #footer>
        ...
        <div v-else class="p-4 font-bold text-red-500 bg-red-100 rounded-md shadow-md ">
            You are not authorized to view a list of Consultation Taches
        </div>
    </jig-layout>
</template>
...
<script>
    ...
    export default defineComponent({
        ...
        data() {
            return {
                tableId: 'consultation-taches-dt',
                tableParams: {},
                datatable: null,
                confirmDelete: false,
                currentModel: null,
        ...
        methods: {
            showModel(model) {
                ...
                // this.$inertia.visit(this.route('admin.consultation-taches.show',model.id));
            },
            editModel(model) {
            ...
            async deleteModel() {
                ...
                if (this.currentModel) {
                    this.$inertia.delete(route('admin.consultation-taches.destroy', vm.currentModel),{
                        onFinish: res => {
