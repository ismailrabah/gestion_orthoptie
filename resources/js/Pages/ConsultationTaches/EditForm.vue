<template>
    <form @submit.prevent="updateModel">
        ...
        <div class=" sm:col-span-4">
            ...
            <infinite-select class="w-full" :per-page="15" :api-url="route('api.taches.index')"
                                id="tache" name="tache"
        ...
        <div class=" sm:col-span-4">
            ...
            <jet-checkbox class="p-2" type="checkbox" id="pourcentage_remises" name="pourcentage_remises" :checked="form.pourcentage_remises" v-model="form.pourcentage_remises"
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            async updateModel() {
                this.form.put(this.route('api.consultation-taches.update',{consultation : this.form.consultation.id , tache : this.form.tache.id}),
                    {
                        onSuccess: res => {
