...
class FillPermissionsForRendezVousStatuses extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRendezVousStatuses constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Rendez Vous Status Module' => 'rendez-vous-statuses',
            'List All Rendez Vous Status' => 'rendez-vous-statuses.index',
            'Create New Rendez Vous Status' => 'rendez-vous-statuses.create',
            'View Any Rendez Vous Status' => 'rendez-vous-statuses.show',
            'Edit or Update a Single Rendez Vous Status' => 'rendez-vous-statuses.edit',
            'Delete Rendez Vous Status' => 'rendez-vous-statuses.delete',
        ]);
