<template>
    <jig-layout>
        <template #header>
            ...
            >
                <inertia-link
                    :href="route('admin.rendez-vouses.index')"
                    class="text-2xl font-black text-white"
                ><i class="fas fa-arrow-left"></i> Retour| Details Du Rendez Vou
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-rendez-vous-form :model="model"></show-rendez-vous-form>
            </div>
        </div>
...
<script>
    ...
    import ShowRendezVousForm from "./ShowForm.vue"
