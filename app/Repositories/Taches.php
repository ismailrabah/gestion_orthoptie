...
{
    private Tach $model;
    public static function init(Tach $model): Taches
    {
        $instance = new self;
    ...
    public static function store(object $data): Tach
    {
        $model = new Tach((array) $data);
                // Save Relationships
    ...
    public function show(Request $request): Tach {
        //Fetch relationships
            return $this->model;
    }
    public function update(object $data): Tach
    {
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (Tach $model) {
                $actions = '';
