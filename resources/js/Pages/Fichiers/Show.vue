<template>
    <jig-layout>
        <template #header>
            ...
            >
                <inertia-link
                    :href="route('admin.fichiers.index')"
                    class="text-2xl font-black text-white"
                ><i class="fas fa-arrow-left"></i> Retour| Details De Fichier
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-fichiers-form :model="model"></show-fichiers-form>
            </div>
        </div>
...
<script>
    ...
    import ShowFichiersForm from "./ShowForm.vue"
