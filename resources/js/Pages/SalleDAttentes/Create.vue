        ...
        <template #header>
            <div class="flex flex-wrap items-center justify-between w-full px-4">
                <inertia-link :href="route('admin.salle-d-attentes.index')"
                        ...
                        class="fas fa-arrow-left"></i> Retour| Nouveau Salle d'attente
                </inertia-link>
            </div>
        </template>
        <div class="flex flex-wrap px-4">
            <div class="z-10 flex-auto max-w-2xl p-4 mx-auto bg-white md:rounded-md md:shadow-md">
                <create-salle-d-attentes-form @success="onSuccess" @error="onError"/>
            </div>
        </div>
    </jig-layout>
</template>
...
<script>
    ...
    import CreateSalleDAttentesForm from "./CreateForm.vue";
    import DisplayMixin from "@/Mixins/DisplayMixin.js";
    import { defineComponent } from "vue";

    export default defineComponent({
        name: "CreateSalleDAttentes",
        components: {
            InertiaButton,
            JigLayout,
            CreateSalleDAttentesForm,
        },
        data() {
            return {}
        },
