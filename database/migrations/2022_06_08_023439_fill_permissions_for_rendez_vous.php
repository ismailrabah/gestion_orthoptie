...
class FillPermissionsForRendezVous extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRendezVous constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'List All Rendez Vous' => 'rendez-vous.index',
            'Create New Rendez Vous' => 'rendez-vous.create',
            'View Any Rendez Vou' => 'rendez-vous.show',
            'Edit or Update a Single Rendez Vou' => 'rendez-vous.edit',
            'Delete Rendez Vous' => 'rendez-vous.delete',
        ]);
