...
class SallesDExamens
{
    private SallesDExamen $model;
    public static function init(SallesDExamen $model): SallesDExamens
    {
        $instance = new self;
    ...
    public static function store(object $data): SallesDExamen
    {
        $model = new SallesDExamen((array) $data);
                // Save Relationships
    ...
    public function show(Request $request): SallesDExamen {
        //Fetch relationships
            return $this->model;
    }
    public function update(object $data): SallesDExamen
    {
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (SallesDExamen $model) {
                $actions = '';
