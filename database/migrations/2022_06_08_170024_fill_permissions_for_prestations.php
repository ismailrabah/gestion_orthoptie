...
class FillPermissionsForPrestations extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPrestations constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Prestations Module' => 'prestations',
            'List All Prestations' => 'prestations.index',
            'Create New Prestations' => 'prestations.create',
            'View Any Prestation' => 'prestations.show',
            'Edit or Update a Single Prestation' => 'prestations.edit',
            'Delete Prestations' => 'prestations.delete',
        ]);
