                                    ...
                                    >
                                        <div class="flex-auto p-4">
                                            <div class="flex flex-wrap">
                                                ...
                                                >
                                                    <div
                                                        class="inline-flex items-center justify-center w-12 h-12 p-3 text-center text-white bg-green-500 rounded-full shadow-lg "
                                                    >
                                                        <i
                                        ...
                                        <div class="flex-auto p-4">
                                            <div class="flex flex-wrap">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <i
                                                            class="text-xl fas fa-file-invoice-dollar"
                                                        ></i>
                                                    </div>
                                                </div>
                                            </div>
