<template>
    <jig-layout>
        <template #header>
            ...
            >
                <inertia-link
                    :href="route('admin.consultation-prestations.index')"
                    class="text-2xl font-black text-white"
                ><i class="fas fa-arrow-left"></i> Back | Details of Consultation Prestation
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-consultation-prestations-form :model="model"></show-consultation-prestations-form>
            </div>
        </div>
...
<script>
    ...
    import ShowConsultationPrestationsForm from "./ShowForm.vue"
    import { defineComponent } from "vue";

    export default defineComponent({
        name: "ShowConsultationPrestation",
        components: {
            InertiaButton,
            JigLayout,
