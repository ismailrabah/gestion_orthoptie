...
class FillPermissionsForFichiers extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFichiers constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Fichiers Module' => 'fichiers',
            'List All Fichiers' => 'fichiers.index',
            'Create New Fichiers' => 'fichiers.create',
            'View Any Fichier' => 'fichiers.show',
            'Edit or Update a Single Fichier' => 'fichiers.edit',
            'Delete Fichiers' => 'fichiers.delete',
        ]);
