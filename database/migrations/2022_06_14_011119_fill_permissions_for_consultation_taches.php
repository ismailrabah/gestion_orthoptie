...
class FillPermissionsForConsultationTaches extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForConsultationTaches constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Consultation Taches Module' => 'consultation-taches',
            'List All Consultation Taches' => 'consultation-taches.index',
            'Create New Consultation Taches' => 'consultation-taches.create',
            'View Any Consultation Tach' => 'consultation-taches.show',
            'Edit or Update a Single Consultation Tach' => 'consultation-taches.edit',
            'Delete Consultation Taches' => 'consultation-taches.delete',
        ]);
