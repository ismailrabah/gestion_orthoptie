...
class PatientController  extends Controller
{
    ...
    public function index(IndexPatient $request)
    {
        ...
        $cols = [
            ...
            Column::name('nom')->title('Nom')->sort()->searchable(),
            Column::name('prenom')->title('Prenom')->sort()->searchable(),
            Column::name('adresse')->title('Adresse')->sort()->searchable(),
            ...
            Column::name('ddn')->title('Ddn')->sort()->searchable(),
