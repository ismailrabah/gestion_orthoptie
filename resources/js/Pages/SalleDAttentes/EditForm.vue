<template>
    <form @submit.prevent="updateModel">
        ...
        <div class=" sm:col-span-4">
            ...
            <infinite-select class="w-full" :per-page="15" :api-url="route('api.users.index')" :queryParams="{'role' : 'assistante'}"
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            async updateModel() {
                this.form.put(this.route('admin.salle-d-attentes.update',this.form.id),
                    {
                        onSuccess: res => {
